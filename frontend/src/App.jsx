      ...
      await api.sendMessageStream(
        ...
        switch (eventType) {
          ...
          case 'stage3_complete':
            // Final post-processed response replaces streamed text
