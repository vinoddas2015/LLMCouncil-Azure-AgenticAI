...
AVAILABLE_MODELS = [
    {"id": "claude-opus-4.6", "name": "Claude Opus 4.6", "description": "Latest Anthropic flagship — strongest reasoning, tools & vision"},
    {"id": "gemini-2.5-pro", "name": "Gemini 2.5 Pro", "description": "Google's best reasoning model, 1M context"},
    {"id": "claude-opus-4.5", "name": "Claude Opus 4.5", "description": "Strong tool-using & reasoning model"},
    {"id": "grok-3", "name": "Grok 3", "description": "Strong reasoning, 1M context window"},
    {"id": "gpt-5-mini", "name": "GPT-5 Mini", "description": "Balanced OpenAI model with reasoning"},
    {"id": "gemini-2.5-flash", "name": "Gemini 2.5 Flash", "description": "Fast and efficient for quick tasks"},
    {"id": "gpt-5.2", "name": "GPT-5.2", "description": "Latest OpenAI flagship model"},
]
